...
- Sound: **THE WAR DRONE** — a detuned industrial drone at 100 BPM that escalates with the fight itself: phase 2 adds hats, phase 3 adds a bassline, the final phase adds a panic arp. Every phase transition gets a rising stinger, the **BRUSH PARRY gets a metallic clang** (its signature), shockwaves rumble on the telegraph, and victory earns you an actual fanfare. The dopamine buildup v2 does with combos, this one does with phases.
- One-touch mute: the 🔊 button (top right) or **M**. The cyan accent stays sacred; so does your hearing — master gain 0.2.
