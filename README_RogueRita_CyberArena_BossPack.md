...
- Sound: **THE WAR DRONE** — a detuned industrial drone at 100 BPM that escalates with the fight itself: hats join when the shell fight starts (PHASE I), the bassline arrives with the joints (PHASE II), and the core fight (PHASE III) adds a panic arp. Every phase transition gets a rising stinger, the **BRUSH PARRY gets a metallic clang** (its signature), shockwaves rumble on the telegraph, and victory earns you an actual fanfare. The dopamine buildup v2 does with combos, this one does with phases.
- Volume that respects you: the 🔊 button (top right) cycles **full → half → mute**; **M** toggles mute. The cyan accent stays sacred; so does your hearing — master gain 0.2.
